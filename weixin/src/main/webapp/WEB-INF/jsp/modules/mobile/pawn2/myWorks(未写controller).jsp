...
<div id="check-now-works" class="div-hide div-outer">
    <div class="works-all-outer">
        <div class="works-all">
...
<div id="check-failure-works" class="div-hide div-outer">
    <div class="works-all-outer">
        <div class="works-all">
...
<div id="check-draft-works" class="div-hide div-outer">
    <div class="works-all-outer">
        <div class="works-all">
            <img src="img/cut/index-all.png" alt="" class="works-img-all"/>
            <textarea class="works-intro-all">新疆和田玉籽料,原皮原色,可玩可做,底部带一块僵,宽33毫米,厚15毫米,高53毫米,重41克.</textarea>
        </div>
        <div class="works-floor-all">
            <span class="works-floor-name-all">冰阳绿树叶吊坠</span>
    ...
    <div class="works-all-outer">
        <div class="works-all">
            <img src="img/headImg/10.jpg" alt="" class="works-img-all"/>
            <textarea class="works-intro-all">新疆和田玉籽料,原皮原色,可玩可做,底部带一块僵,宽33毫米,厚15毫米,高53毫米,重41克.</textarea>
        </div>
        <div class="works-floor-all">
            <span class="works-floor-name-all">冰阳绿树叶吊坠</span>
    ...
    <div class="works-all-outer">
        <div class="works-all">
            <img src="img/headImg/11.jpg" alt="" class="works-img-all"/>
            <textarea class="works-intro-all">新疆和田玉籽料,原皮原色,可玩可做,底部带一块僵,宽33毫米,厚15毫米,高53毫米,重41克.</textarea>
        </div>
        <div class="works-floor-all">
            <span class="works-floor-name-all">冰阳绿树叶吊坠</span>

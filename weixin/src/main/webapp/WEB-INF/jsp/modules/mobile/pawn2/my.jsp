...
<div class="weui-grids div-outer">
    ...
    <a href="javascript:;" class="weui-grid">
        <div class="weui-grid__icon">
            <img src="${ctxStatic}/img/cut/mywait.png" alt="">
        </div>

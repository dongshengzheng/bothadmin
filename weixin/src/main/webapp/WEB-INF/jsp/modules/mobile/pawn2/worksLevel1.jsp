...
<script>
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#load-worksLevel1 select[name="ganguan"]').html(ganguan);
            ...
            $('#load-worksLevel1 select[name="moshidu"]').html(moshidu);
            ...
            $('#load-worksLevel1 select[name="xuexing"]').html(xuexing);
            ...
            $('#load-worksLevel1 select[name="nongyandu"]').html(nongyandu);
            ...
            $('#load-worksLevel1 select[name="hanxuefangshi"]').html(hanxuefangshi);
            ...
            $('#load-worksLevel1 select[name="ziranshipi"]').html(ziranshipi);
        }
    })
</script>

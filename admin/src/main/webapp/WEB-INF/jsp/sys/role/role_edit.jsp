            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" id="removable" name="removable">
                        <option value="1"
                                <c:if test="${role.removable == 1}">selected</c:if>>是
                        </option>
                        <option value="0"
                                <c:if test="${role.removable == 0}">selected</c:if>>否
                        </option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" id="allocatable" name="allocatable">
                        <option value="1"
                                <c:if test="${role.allocatable == 1}">selected</c:if>>是
                        </option>
                        <option value="0"
                                <c:if test="${role.allocatable == 0}">selected</c:if>>否
                        </option>
                    </select>
                </div>
            </div>

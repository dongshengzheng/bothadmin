...
public class WorksDetailController extends BaseController {
    ...
    @RequestMapping(value = "detailAdmin/{id}", method = RequestMethod.GET)
    public String detailForAdmin(@PathVariable Integer id,
                         ModelMap map) {
        if (id == null) {
            return "redirect:/";
        }
        ...
        return "works/work_detail_admin";
    }
    ...
    @RequestMapping(value = "levelDetails/{id}/{breed}", method = RequestMethod.GET)
    public String getLevelDetails(@PathVariable Integer id,@PathVariable String breed,
                                  ModelMap map) {
        if (id == null) {
            return "redirect:/";
        }

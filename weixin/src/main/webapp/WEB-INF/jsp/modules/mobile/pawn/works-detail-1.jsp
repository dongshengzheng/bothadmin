...
<div class="weui_cells weui_cells_form">
    ...
    <div class="weui_cell">
        ...
        <div class="weui_cell_bd weui_cell_primary">
            <span><fmt:formatDate value="${provider.datetime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
        </div>
    </div>
</div>
...
<div class="weui_cells weui_cells_form" style="margin-bottom: 15px;">
    <div class="weui_cell">
        <div class="weui_cell_bd weui_cell_primary">
            <textarea class="weui_textarea" rows="3">${provider.remark}</textarea>
        </div>
    </div>
</div>
<c:if test="${user.office.name != '普通用户' && works.status == 1}">
<div style="padding:0px 10%;">
    <a href="javascript:;" class="weui_btn weui_btn_warn" onclick="toPage(1)">下一页</a>
</div>
</c:if>
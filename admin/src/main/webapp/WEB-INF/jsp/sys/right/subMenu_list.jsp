            ...
            "columnDefs": [{
                ...
                "render": function (data, type, row) {
                    return ""
                            ...
                            + '<a href="right/editMenu?menuId=' + row.menuId + '" class="btn btn-outline btn-circle btn-sm green" data-model="dialog"><i class="fa fa-pencil"></i>编辑</a>'
                            </shiro:hasPermission>
                            <shiro:hasPermission name="right/deleteMenu">
                            + '<a href="right/deleteMenu?menuId=' + row.menuId + '"  class="btn btn-outline btn-circle btn-sm green" data-msg="将删除该菜单下的所有权限，确定删除吗？" data-model="ajaxToDo" data-callback="refreshTable"><i class="fa fa-trash-o"></i>删除</a>'
                            </shiro:hasPermission>
                            <shiro:hasPermission name="right/button">
                            + '<a href="right/button?menuId=' + row.menuId + '" class="btn btn-outline btn-circle btn-sm green" data-target="navTab">查看权限</a>'
                            </shiro:hasPermission>;
                }
            }],

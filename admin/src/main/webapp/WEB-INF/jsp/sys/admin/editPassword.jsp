    ...
    <div class="modal-body">
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input id="password" name="password" type="password" maxlength="32" minlength="2"
                           class="form-control required" placeholder="请输入新密码">
                </div>
            </div>
            <div class="form-group">
                <label for="passwordAgain" class="col-sm-2 control-label">重复新密码</label>
                <div class="col-sm-7">
                    <input id="passwordAgain" equalTo="#password" type="password" maxlength="32" minlength="2"
                           class="form-control required" placeholder="请再次输入新密码">
                </div>
            </div>
